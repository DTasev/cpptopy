...
class UCharVector(_object):
    ...
    def iterator(self):
        return _example.UCharVector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _example.UCharVector___nonzero__(self)

    def __bool__(self):
        return _example.UCharVector___bool__(self)

    def __len__(self):
        return _example.UCharVector___len__(self)

    def __getslice__(self, i, j):
        return _example.UCharVector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _example.UCharVector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _example.UCharVector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _example.UCharVector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _example.UCharVector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _example.UCharVector___setitem__(self, *args)

    def pop(self):
        return _example.UCharVector_pop(self)

    def append(self, x):
        return _example.UCharVector_append(self, x)

    def empty(self):
        return _example.UCharVector_empty(self)

    def size(self):
        return _example.UCharVector_size(self)

    def swap(self, v):
        return _example.UCharVector_swap(self, v)

    def begin(self):
        return _example.UCharVector_begin(self)

    def end(self):
        return _example.UCharVector_end(self)

    def rbegin(self):
        return _example.UCharVector_rbegin(self)

    def rend(self):
        return _example.UCharVector_rend(self)

    def clear(self):
        return _example.UCharVector_clear(self)

    def get_allocator(self):
        return _example.UCharVector_get_allocator(self)

    def pop_back(self):
        return _example.UCharVector_pop_back(self)

    def erase(self, *args):
        return _example.UCharVector_erase(self, *args)

    def __init__(self, *args):
        this = _example.new_UCharVector(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def push_back(self, x):
        return _example.UCharVector_push_back(self, x)

    def front(self):
        return _example.UCharVector_front(self)

    def back(self):
        return _example.UCharVector_back(self)

    def assign(self, n, x):
        return _example.UCharVector_assign(self, n, x)

    def resize(self, *args):
        return _example.UCharVector_resize(self, *args)

    def insert(self, *args):
        return _example.UCharVector_insert(self, *args)

    def reserve(self, n):
        return _example.UCharVector_reserve(self, n)

    def capacity(self):
        return _example.UCharVector_capacity(self)
    __swig_destroy__ = _example.delete_UCharVector
    __del__ = lambda self: None
UCharVector_swigregister = _example.UCharVector_swigregister
UCharVector_swigregister(UCharVector)

class MyImage(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, MyImage, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, MyImage, name)
    __repr__ = _swig_repr

    def __len__(self):
        return _example.MyImage___len__(self)

    def __str__(self):
        return _example.MyImage___str__(self)
    __swig_setmethods__["data"] = _example.MyImage_data_set
    __swig_getmethods__["data"] = _example.MyImage_data_get
    if _newclass:
        data = _swig_property(_example.MyImage_data_get, _example.MyImage_data_set)
    __swig_setmethods__["width"] = _example.MyImage_width_set
    __swig_getmethods__["width"] = _example.MyImage_width_get
    if _newclass:
        width = _swig_property(_example.MyImage_width_get, _example.MyImage_width_set)
    __swig_setmethods__["height"] = _example.MyImage_height_set
    __swig_getmethods__["height"] = _example.MyImage_height_get
    if _newclass:
        height = _swig_property(_example.MyImage_height_get, _example.MyImage_height_set)

    def __init__(self):
        this = _example.new_MyImage()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _example.delete_MyImage
    __del__ = lambda self: None
MyImage_swigregister = _example.MyImage_swigregister
MyImage_swigregister(MyImage)

class Apples(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, Apples, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, Apples, name)
    __repr__ = _swig_repr

    def get(self):
        return _example.Apples_get(self)

    def vec(self):
        return _example.Apples_vec(self)

    def decode(self, filename):
        return _example.Apples_decode(self, filename)

    def __init__(self):
        this = _example.new_Apples()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _example.delete_Apples
    __del__ = lambda self: None
Apples_swigregister = _example.Apples_swigregister
Apples_swigregister(Apples)
